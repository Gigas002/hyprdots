...
Y|N|${HOME}/.config/hypr/themes|${Fav_Theme}.conf|hyprland
Y|N|${HOME}/.config/Kvantum|${Fav_Theme}|kvantum
Y|N|${HOME}/.config/qt5ct/colors|${Fav_Theme}.conf|qt5ct
Y|N|${HOME}/.config/qt6ct/colors|${Fav_Theme}.conf|qt6ct
Y|N|${HOME}/.config/rofi/themes|${Fav_Theme}.rasi|rofi
Y|N|${HOME}/.config/swww|${Fav_Theme}|swww
Y|N|${HOME}/.config/waybar/themes|${Fav_Theme}.css|waybar
THEME
